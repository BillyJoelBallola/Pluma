...
import { RegisterInput, selectRegisterSchema } from "@/zod-schemas/auth";
...
export default function Login() {
  ...
  const {
    ...
    mode: "onBlur",
    resolver: zodResolver(selectRegisterSchema),
        ...
        <div className="text-center w-full sm:w-[22rem]">
          ...
          <form className="mt-8 grid gap-4" onSubmit={handleSubmit(onSubmit)}>
            <Input
              ...
              type="text"
              className={errors.username?.message && "border border-red-500"}
              {...register("username")}
            />
            <Input
